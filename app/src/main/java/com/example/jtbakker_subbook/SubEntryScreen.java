...
public class SubEntryScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String errorTitle = getString(R.string.error_dialog_button);
        this.errorDialog.setButton(AlertDialog.BUTTON_NEUTRAL, errorTitle, new DialogInterface.OnClickListener() {
            @Override
